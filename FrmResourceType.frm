...
Begin VB.Form FrmResourceType 
   ...
   End
End
Attribute VB_Name = "FrmResourceType"
...
With MyDDE
    ...
    .PrepareDelete = " DELETE FROM [Resources Type] WHERE   ([TypeID] = " & FNumText(FNumText(txtBox(0))) & ") "
End With
End Sub
