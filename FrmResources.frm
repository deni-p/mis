...
Private Sub PrepareQuery()
    ...
    With MyDDE
        .PrepareAppend = " INSERT INTO [Resources Type] ([TypeID], [Description],[TimeUsed]) " & " VALUES (N'" & (txtBox(0)) & "', N'" & txtBox(1) & "'," & Check1.value & ")"
