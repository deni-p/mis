...
With MyDDE
    ...
    Set .BindForm = FrmEntriKas
    .BindFormTAG = "KAS"
    Set .ActiveConnection = Cnn
    .PrepareQuery = "SELECT BankID, NoAccount, TypeBank, NamaBank, Amount FROM         [Temp Bank] where typetrans ='BANK' ORDER BY BankID"
End With
End Sub
...
Select Case AdReasonActiveDb
       ...
       Case tmbEdit:
            ...
            txtKas(1).SetFocus
       Case tmbPrint:
            CallRPTReport "Laporan Bank.rpt"
...
With MyDDE
    .PrepareAppend = " INSERT INTO [Temp Bank]" & _
                     ...
                     " VALUES     (N'" & ValidString(txtKas(0)) & "', N'" & cboKas.BoundText & "', N'" & ValidString(txtKas(1)) & "', N'" & ValidString(txtKas(2)) & "', " & CDbl(txtKas(3)) & ",'BANK')"
...
RcAcc.DBOpen "SELECT     NoAccount, AccountName FROM         GlAccount WHERE     (Type = N'Cash' OR Type = N'bank') AND ([Group] = N'List Account') ORDER BY AccountName", Cnn, lckLockReadOnly
