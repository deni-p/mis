...
Begin VB.Form FrmTabelBiaya 
   Caption         =   "Kelompok Biaya"
   ClientHeight    =   5625
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10125
   ...
   End
End
Attribute VB_Name = "FrmTabelBiaya"
...
With MyDDE
    ...
    Set .BindForm = FrmTabelBiaya
    .BindFormTAG = "Partner"
    Set .ActiveConnection = Cnn
    .PrepareQuery = "Select * from [Tabel Biaya] order by [Kode Biaya]"
End With
End Sub
...
With MyDDE
    .PrepareAppend = " INSERT INTO [Tabel Biaya] ([Kode Biaya], [Nama Biaya]) " & _
                     " VALUES (N'" & ValidString(txtBox(0)) & "', N'" & ValidString(txtBox(1)) & "')"

    .PrepareUpdate = " UPDATE [Tabel Biaya] Set [Nama Biaya] = N'" & ValidString(txtBox(1)) & "' WHERE     ([Kode Biaya] = N'" & ValidString(txtBox(0)) & "')"

    .PrepareDelete = " DELETE FROM [Tabel Biaya] WHERE   ([Kode Biaya] = N'" & ValidString(txtBox(0)) & "') "
End With
End Sub

Private Sub GridLayout()
DataGrid1(0).Height = 2250
DataGrid1(0).Width = 6795
End Sub
