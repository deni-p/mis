...
Begin VB.Form frmbom2 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmbom2.frx":6852
         Left            =   6060
         List            =   "frmbom2.frx":6862
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmbom2.frx":6C14
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "Picture4"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Material"
         TabPicture(1)   =   "frmbom2.frx":6C30
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "Picture5"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "BOM Structure"
         TabPicture(2)   =   "frmbom2.frx":6C4C
         Tab(2).ControlEnabled=   -1  'True
         Tab(2).Control(0)=   "semeruBOM"
         Tab(2).Control(0).Enabled=   0   'False
         Tab(2).Control(1)=   "tgBOM"
         Tab(2).Control(1).Enabled=   0   'False
         Tab(2).ControlCount=   2
         TabCaption(3)   =   "Routing"
         TabPicture(3)   =   "frmbom2.frx":6C68
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "Picture1"
         Tab(3).ControlCount=   1
         TabCaption(4)   =   "Bill of Manufacture"
         TabPicture(4)   =   "frmbom2.frx":6C84
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "Line1(21)"
         Tab(4).Control(1)=   "Label1(20)"
         Tab(4).Control(2)=   "Line1(20)"
         Tab(4).Control(3)=   "Label1(19)"
         Tab(4).Control(4)=   "Line1(19)"
         Tab(4).Control(5)=   "Label1(18)"
         Tab(4).Control(6)=   "Line1(18)"
         Tab(4).Control(7)=   "Label1(17)"
         Tab(4).Control(8)=   "Line1(17)"
         Tab(4).Control(9)=   "Label1(16)"
         Tab(4).Control(10)=   "lblUOM"
         Tab(4).Control(11)=   "Label1(15)"
         Tab(4).Control(12)=   "Line1(16)"
         Tab(4).Control(13)=   "SemeruTree1"
         Tab(4).Control(14)=   "txt(1)"
         Tab(4).Control(15)=   "txt(4)"
         Tab(4).Control(16)=   "txt(0)"
         Tab(4).Control(17)=   "txt(3)"
         Tab(4).Control(18)=   "txt(5)"
         Tab(4).Control(19)=   "txt(2)"
         ...
         Begin TrueOleDBGrid80.TDBGrid tgBOM 
            ...
            Splits(0)._ColumnProps(1)=   "Column(0).Width=3466"
            ...
            Splits(0)._ColumnProps(7)=   "Column(1).Width=212"
            Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
            Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=132"
            ...
            Splits(1)._ColumnProps(7)=   "Column(1).Width=2699"
            Splits(1)._ColumnProps(8)=   "Column(1).DividerColor=0"
            Splits(1)._ColumnProps(9)=   "Column(1)._WidthInPix=2619"
            Splits(1)._ColumnProps(10)=   "Column(1).Order=2"
            Splits(1)._ColumnProps(11)=   "Column(2).Width=3360"
            Splits(1)._ColumnProps(12)=   "Column(2).DividerColor=0"
            Splits(1)._ColumnProps(13)=   "Column(2)._WidthInPix=3281"
            Splits(1)._ColumnProps(14)=   "Column(2).Order=3"
            Splits(1)._ColumnProps(15)=   "Column(3).Width=1720"
            Splits(1)._ColumnProps(16)=   "Column(3).DividerColor=0"
            Splits(1)._ColumnProps(17)=   "Column(3)._WidthInPix=1640"
            ...
            _StyleDefs(11)  =   "FooterStyle:id=3,.parent=1,.namedParent=35,.bold=0,.fontsize=825,.italic=0"
            _StyleDefs(12)  =   ":id=3,.underline=0,.strikethrough=0,.charset=0"
            _StyleDefs(13)  =   ":id=3,.fontname=Tahoma"
            ...
            _StyleDefs(22)  =   "Splits(0).Style:id=47,.parent=1"
            _StyleDefs(23)  =   "Splits(0).CaptionStyle:id=56,.parent=4"
            _StyleDefs(24)  =   "Splits(0).HeadingStyle:id=48,.parent=2"
            _StyleDefs(25)  =   "Splits(0).FooterStyle:id=49,.parent=3"
            _StyleDefs(26)  =   "Splits(0).InactiveStyle:id=50,.parent=5"
            _StyleDefs(27)  =   "Splits(0).SelectedStyle:id=52,.parent=6"
            _StyleDefs(28)  =   "Splits(0).EditorStyle:id=51,.parent=7"
            _StyleDefs(29)  =   "Splits(0).HighlightRowStyle:id=53,.parent=8"
            _StyleDefs(30)  =   "Splits(0).EvenRowStyle:id=54,.parent=9"
            _StyleDefs(31)  =   "Splits(0).OddRowStyle:id=55,.parent=10"
            _StyleDefs(32)  =   "Splits(0).RecordSelectorStyle:id=57,.parent=11"
            _StyleDefs(33)  =   "Splits(0).FilterBarStyle:id=58,.parent=12"
            _StyleDefs(34)  =   "Splits(0).Columns(0).Style:id=62,.parent=47,.valignment=2"
            _StyleDefs(35)  =   "Splits(0).Columns(0).HeadingStyle:id=59,.parent=48"
            _StyleDefs(36)  =   "Splits(0).Columns(0).FooterStyle:id=60,.parent=49"
            _StyleDefs(37)  =   "Splits(0).Columns(0).EditorStyle:id=61,.parent=51"
            _StyleDefs(38)  =   "Splits(0).Columns(1).Style:id=66,.parent=47"
            _StyleDefs(39)  =   "Splits(0).Columns(1).HeadingStyle:id=63,.parent=48"
            _StyleDefs(40)  =   "Splits(0).Columns(1).FooterStyle:id=64,.parent=49"
            _StyleDefs(41)  =   "Splits(0).Columns(1).EditorStyle:id=65,.parent=51"
            _StyleDefs(42)  =   "Splits(0).Columns(2).Style:id=70,.parent=47"
            _StyleDefs(43)  =   "Splits(0).Columns(2).HeadingStyle:id=67,.parent=48"
            _StyleDefs(44)  =   "Splits(0).Columns(2).FooterStyle:id=68,.parent=49"
            _StyleDefs(45)  =   "Splits(0).Columns(2).EditorStyle:id=69,.parent=51"
            _StyleDefs(46)  =   "Splits(0).Columns(3).Style:id=74,.parent=47"
            _StyleDefs(47)  =   "Splits(0).Columns(3).HeadingStyle:id=71,.parent=48"
            _StyleDefs(48)  =   "Splits(0).Columns(3).FooterStyle:id=72,.parent=49"
            _StyleDefs(49)  =   "Splits(0).Columns(3).EditorStyle:id=73,.parent=51"
            _StyleDefs(50)  =   "Splits(1).Style:id=13,.parent=1"
            _StyleDefs(51)  =   "Splits(1).CaptionStyle:id=22,.parent=4"
            _StyleDefs(52)  =   "Splits(1).HeadingStyle:id=14,.parent=2"
            _StyleDefs(53)  =   "Splits(1).FooterStyle:id=15,.parent=3"
            _StyleDefs(54)  =   "Splits(1).InactiveStyle:id=16,.parent=5"
            _StyleDefs(55)  =   "Splits(1).SelectedStyle:id=18,.parent=6"
            _StyleDefs(56)  =   "Splits(1).EditorStyle:id=17,.parent=7"
            _StyleDefs(57)  =   "Splits(1).HighlightRowStyle:id=19,.parent=8"
            _StyleDefs(58)  =   "Splits(1).EvenRowStyle:id=20,.parent=9"
            _StyleDefs(59)  =   "Splits(1).OddRowStyle:id=21,.parent=10"
            _StyleDefs(60)  =   "Splits(1).RecordSelectorStyle:id=23,.parent=11"
            _StyleDefs(61)  =   "Splits(1).FilterBarStyle:id=24,.parent=12"
            _StyleDefs(62)  =   "Splits(1).Columns(0).Style:id=28,.parent=13"
            _StyleDefs(63)  =   "Splits(1).Columns(0).HeadingStyle:id=25,.parent=14"
            _StyleDefs(64)  =   "Splits(1).Columns(0).FooterStyle:id=26,.parent=15"
            _StyleDefs(65)  =   "Splits(1).Columns(0).EditorStyle:id=27,.parent=17"
            _StyleDefs(66)  =   "Splits(1).Columns(1).Style:id=32,.parent=13"
            _StyleDefs(67)  =   "Splits(1).Columns(1).HeadingStyle:id=29,.parent=14"
            _StyleDefs(68)  =   "Splits(1).Columns(1).FooterStyle:id=30,.parent=15"
            _StyleDefs(69)  =   "Splits(1).Columns(1).EditorStyle:id=31,.parent=17"
            _StyleDefs(70)  =   "Splits(1).Columns(2).Style:id=46,.parent=13"
            _StyleDefs(71)  =   "Splits(1).Columns(2).HeadingStyle:id=43,.parent=14"
            _StyleDefs(72)  =   "Splits(1).Columns(2).FooterStyle:id=44,.parent=15"
            _StyleDefs(73)  =   "Splits(1).Columns(2).EditorStyle:id=45,.parent=17"
            _StyleDefs(74)  =   "Splits(1).Columns(3).Style:id=78,.parent=13"
            _StyleDefs(75)  =   "Splits(1).Columns(3).HeadingStyle:id=75,.parent=14"
            _StyleDefs(76)  =   "Splits(1).Columns(3).FooterStyle:id=76,.parent=15"
            _StyleDefs(77)  =   "Splits(1).Columns(3).EditorStyle:id=77,.parent=17"
         ...
         Begin VB.PictureBox Picture4 
            ...
            Begin VB.TextBox txtBox 
               ...
               ScrollBars      =   2  'Vertical
               TabIndex        =   12
               Text            =   "frmbom2.frx":6CC1
               Top             =   3510
               Width           =   6360
            End
            Begin MSDataGridLib.DataGrid DataGrid1 
               Bindings        =   "frmbom2.frx":6CC7
               Height          =   3120
               Index           =   0
               Left            =   0
               TabIndex        =   13
...
On Error GoTo 1
   RsTeeBOM.DBRecordset.MoveFirst
   RsTeeBOM.DBRecordset.Find "noItem='" & Node.Key & "'", , adSearchForward, 1
   If Not RsTeeBOM.DBRecordset.EOF Then
...
'RcComponent.DBOpen "SELECT [BOM Component Detail].SeqStageID, [BOM Component Detail].Description AS Keterangan, [BOM Component Detail].Component AS [Komponen ID],                       Inventory.ItemName AS [Nama Komponen], [BOM Component Detail].UOM, [BOM Component Detail].QTYUsage,[BOM Component Detail].Noline FROM         [BOM Component Detail] INNER JOIN                      Inventory ON [BOM Component Detail].Component = Inventory.NoItem WHERE     ([BOM Component Detail].NoItem = N'" & Param & "')", Cnn, lckLockBatch
'RcComponent.DBOpen " SELECT [BOM Component Detail].WCID AS SeqStageID, [BOM Component Detail].Description AS Keterangan, [BOM Component Detail].Component AS [Komponen ID],  Inventory.ItemName AS [Nama Komponen], [BOM Component Detail].UOM, [BOM Component Detail].QTYUsage FROM         [BOM Component Detail] INNER JOIN Inventory ON [BOM Component Detail].Component = Inventory.NoItem LEFT OUTER JOIN  [BOM Stage Detail] ON [BOM Component Detail].BomReff = [BOM Stage Detail].BomReff AND  [BOM Component Detail].NoItem = [BOM Stage Detail].NoItem AND [BOM Component Detail].SeqStageID = [BOM Stage Detail].SeqStageID WHERE     ([BOM Component Detail].NoItem = N'" & Param & "') AND ([BOM Stage Detail].BomReff = N'" & MyDDE.GetFieldByName("BomReff") & "') ORDER BY [BOM Stage Detail].NoLine", Cnn, lckLockBatch
'RcComponent.DBOpen " SELECT [BOM Component Detail].WCID,[BOM Component Detail].SeqStageID AS SeqStageID, [BOM Component Detail].Description AS Keterangan, [BOM Component Detail].Component AS [Komponen ID], Inventory.ItemName AS [Nama Komponen], [BOM Component Detail].UOM, [BOM Component Detail].QTYUsage" & _
'                   " FROM [BOM Component Detail] INNER JOIN Inventory ON [BOM Component Detail].Component = Inventory.NoItem LEFT OUTER JOIN [BOM Stage Detail] ON [BOM Component Detail].BomReff = [BOM Stage Detail].BomReff AND  [BOM Component Detail].NoItem = [BOM Stage Detail].NoItem WHERE     ([BOM Component Detail].NoItem = N'" & Param & "') AND ([BOM Stage Detail].BomReff = N'" & MyDDE.GetFieldByName("BomReff") & "') ORDER BY [BOM Stage Detail].NoLine", Cnn
...
'Debug.Print RcComponent.DBRecordset.Source
