...
Private Sub lotno_RowColChange(ByVal TagForm As String, _
                               ByVal pRecordset As ADODB.Recordset)
    Text1(0).Text = rslotno.DBRecordset.Fields("id_blending")
    Text1(16).Text = rslotno.DBRecordset.Fields("lot_no")
End Sub

Private Sub op_shiever_RowColChange(ByVal TagForm As String, _
                                    ByVal pRecordset As ADODB.Recordset)
        ...
        If .Recordcount <> 0 Then
            ...
            If SendDataToServer(" delete from [SHIEVER_DETAIL] where (lot_no = '" & DDE.GetFieldByName("lot_no") & "')") = True Then
                ...
                Do
                    ...
                    SendDataToServer "insert into SHIEVER_DETAIL (lot_no,nama_shiever,jumlah,satuan)  " & " values ('" & Text1(16).Text & "', " & " '" & .Fields("nama_shiever") & "', " & " '" & .Fields("jumlah") & "', " & " '" & .Fields("satuan") & "')"
                    .MoveNext
                Loop
