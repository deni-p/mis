...
Begin VB.Form frmProdAcid 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin TrueOleDBGrid80.TDBGrid gridPencucian 
         ...
         _StyleDefs(62)  =   ":id=39,.parent=33,.bgcolor=&HC0C0C0&"
...
Private Sub Form_Load()
    ...
    With MyDDE
        ...
        .PrepareQuery = "SELECT * From acid_treatment"
...
Private Sub OpenDetail(ByVal ParameterString As String)
      RsDetail.DBOpen "select * from acid_detail where no_ekstraksi='" & ParameterString & "' ", CNN
      Set gridDetail.DataSource = RsDetail.DBRecordset
      
      RsPencucian.DBOpen "select * from acid_pencucian where no_ekstraksi='" & ParameterString & "' ", CNN
...
Private Sub lblEkstraksi_LostFocus()
   ...
   If rsCek.DBRecordset.Recordcount > 0 Then
      rsCek.DBOpen "select * from acid_treatment where no_Ekstraksi='" & lblEkstraksi.Text & "'", CNN, lckLockBatch
      If rsCek.DBRecordset.Recordcount > 0 Then
...
Private Sub AddDetail()
   With RsDetail.DBRecordset
      '*** 1
      .AddNew
      .Fields("tahap") = "Air bersih untuk penambahan proses Acid"
      .Fields("ID_Tahapan") = 1
      ...
      '*** 6
      .AddNew
      .Fields("tahap") = "Larutan Acid Akhir"
      .Fields("ID_Tahapan") = 3
      .Fields("proses") = "Jumlah (Liter)"
      ...
      '*** 9
      .AddNew
      .Fields("tahap") = "Waktu Acid Treatmnet"
      .Fields("ID_Tahapan") = 4
...
Private Sub PrepareQuery()
    ...
    With MyDDE
        .PrepareAppend = "INSERT INTO [Acid_treatment] " & _
        ...
        .PrepareUpdate = "UPDATE [Acid_treatment] SET " & _
        ...
        .PrepareDelete = "DELETE From acid_treatment Where no_ekstraksi='" & lblEkstraksi & "'"
    End With
...
On Error GoTo xErr
   ...
   SendDataToServer "delete from acid_detail where no_ekstraksi='" & lblEkstraksi & "'"
   With RsDetail.DBRecordset
      .MoveFirst
      While Not .EOF
         SendDataToServer "INSERT INTO [acid_detail] ([no_ekstraksi]" & _
                                 ",[tahap]" & _
                                 ",[proses]" & _
                                 ",[nilai]" & _
                                 ",[rekomendasi]" & _
   ...
   SendDataToServer "delete from acid_pencucian where no_ekstraksi='" & lblEkstraksi & "'"
   
   With RsPencucian.DBRecordset
      .MoveFirst
      While Not .EOF
         SendDataToServer "INSERT INTO [Acid_pencucian] ([no_ekstraksi] " & _
                              ",[pencucian]" & _
                              ",[jml_air]" & _
                              ",[waktu_mulai]" & _
                              ",[waktu_selesai]) " & _
