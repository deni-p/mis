   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabHeight       =   520
            TabCaption(0)   =   "Page 1"
            TabPicture(0)   =   "FrmBleach.frx":0000
            ...
            TabCaption(1)   =   "Page 2"
            TabPicture(1)   =   "FrmBleach.frx":001C
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "Frame2(2)"
            Tab(1).ControlCount=   1
            TabCaption(2)   =   "Page 3"
            TabPicture(2)   =   "FrmBleach.frx":0038
...
Function Simpan_proses_1()
   ...
   Set rsProses = CNN.Execute("insert into Z_bleaching_treatment(no_ekstraksi,jumlah_air,type_bleaching,jumlah_bleaching,konsentrasi_bleaching,waktu,jumlah_bleaching_akhir,konsentrasi_bleaching_akhir,suhu_1,waktu_mulai,suhu_2,waktu_selesai,total) values " & _
                          "('" & Text1(16).Text & "', '" & Text1(2).Text & "', '" & Text1(3).Text & "', '" & Text1(5).Text & "', '" & Text1(6).Text & "', '" & Text1(7).Text & "', '" & Text1(11).Text & "','" & Text1(10).Text & "', '" & Text1(9).Text & "', '" & Text1(8).Text & "', '" & Text1(12).Text & "', '" & Text1(14).Text & "', '" & Text1(13).Text & "')")
