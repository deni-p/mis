...
Begin VB.Form frmVcrBeli 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ComboBox cboVoucher 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmVcrBeli.frx":6852
         Left            =   10860
         List            =   "frmVcrBeli.frx":6859
...
With MyDDE
    ...
    .PrepareQuery = " SELECT TransData.TransID, TransData.RefNotes, TransData.DateTrans, " & _
                    ...
                    " GLAccount ON TransData.bankid = GLAccount.NoAccount WHERE (TransData.TypeTrans = N'BP') or (TransData.TypeTrans = N'AP') " & _
...
Select Case AdReasonActiveDb
       ...
       Dim IDGen As New IDGenerator
            ...
            'Select Case cboVoucher
                   ...
                   'MyDDE.GetFieldByName("TransID") = MyData.PrepareIndex(tmbVoucher, 5, mVarTipe, TglIndex)
            MyDDE.GetFieldByName("TransID") = IDGen.GetID("VP")
...
Select Case Left(ParamVoucher, 2)
       Case "BP", "PP", "BE":
            ...
            DGPurchase.Columns(4).Visible = True
'            Debug.Print DGPurchase.Columns(2).Caption
...
With DGPurchase
    ...
    .Columns(3).Caption = "Total Hutang"
