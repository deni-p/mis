...
Private Sub PrepareQuery()
    ...
    With MyDDE
        .PrepareAppend = " INSERT INTO [Manufacture Stage] ([StageID], [Description],[TypeID],[Note]) " & " VALUES (N'" & (txtBox(0)) & "', N'" & txtBox(1) & "',N'" & DataCombo1.BoundText & "',N'" & txtBox(2) & "')"
